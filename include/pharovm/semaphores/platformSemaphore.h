...
VM_EXPORT Semaphore *platform_semaphore_new(int initialValue);
VM_EXPORT void platform_semaphore_free(Semaphore *semaphore);
VM_EXPORT int platform_semaphore_signal(Semaphore *semaphore);
VM_EXPORT int platform_semaphore_wait(Semaphore *semaphore);
